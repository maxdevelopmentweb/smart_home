<ul class="c-sidebar-nav">
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('/') }}">
            ...
            </svg>@lang('menu.dashboard')</a></li>
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('devices') }}">
            <svg class="c-sidebar-nav-icon">
                <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-calculator') }}"></use>
            </svg>@lang('menu.devices')</a></li>
    <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ url('devices/add') }}">
            <svg class="c-sidebar-nav-icon">
                <use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-pencil')}}"></use>
            </svg>@lang('menu.add_device')</a></li>
